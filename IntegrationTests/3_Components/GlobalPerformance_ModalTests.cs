...
namespace IntegrationTests.Components {
  ...
  public class GlobalPerformance_ModalTests {
    ...
    public void EffectiveMassesZTest() {
      ...
      Assert.Equal(77.91, output1.Value, DoubleComparer.Default);
    }
    ...
    public void FrequenciesTest() {
      ...
      Assert.Equal(11.42, output3.Value, DoubleComparer.Default);
      Assert.Equal(21.26, output4.Value, DoubleComparer.Default);
    }
    ...
    public void ModalMassesTest() {
      ...
      //var output3 = (GH_Number)param.VolatileData.get_Branch(0)[2];
      //var output4 = (GH_Number)param.VolatileData.get_Branch(0)[3];
      Assert.Equal(45.62, output1.Value, DoubleComparer.Default);
      // GSA-6480
      //Assert.Equal(19.75, output2.Value, DoubleComparer.Default);
      //Assert.Equal(16.14, output3.Value, DoubleComparer.Default);
      //Assert.Equal(34.85, output4.Value, DoubleComparer.Default);
    }
