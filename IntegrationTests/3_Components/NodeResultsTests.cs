...
namespace IntegrationTests.Components
{
  ...
  public class NodeResultsTests
  {
    ...
    public void NodeDisplacementTests(string name, double expected1, double expected2, int precision = 6)
    {
      GH_Document doc = Document;
    ...
    public void ReactionForcesTests(string name, double expected1, double expected2, int precision = 6)
    {
      GH_Document doc = Document;
      IGH_Param param = Helper.FindParameter(doc, name);
    ...
    public void ReactionForcesIDsTests()
    {
      ...
      List<GH_Integer> output1 = (List<GH_Integer>)param.VolatileData.get_Branch(0);
