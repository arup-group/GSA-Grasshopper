...
| ![LoadParam](./images/LoadParam.png)                         | `Load   Value  or   Factor   X  [k N , k N /m , k N /m ²]`  | **Load Value or Factor X**     | Value at Start, Point 1 or Factor X.<br />Expression for Face Equation load.                                        |
| ![LoadParam](./images/LoadParam.png)                         | `Load   Value  or   Factor   Y  [k N , k N /m , k N /m ²]`  | **Load Value or Factor Y**     | Value at End, Point 2 or Factor Y.<br />Position X for Face Point load.<br />Equation Axis for Face Equation load.  |
| ![LoadParam](./images/LoadParam.png)                         | `Load   Value  or   Factor   Z  [k N , k N /m , k N /m ²]`  | **Load Value or Factor Z**     | Value at Point 3 or Factor Z.<br />Position Y for Face Point load.<br />Is Constant for Face Equation load.         |
| ![LoadParam](./images/LoadParam.png)                         | `Load   Value  [k N , k N /m , k N /m ²]`                   | **Load Value**                 | Value at Point 4.<br />Units of the equation for Face Equation load                                                 |
