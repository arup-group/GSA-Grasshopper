...
| ![IntegerParam](./images/IntegerParam.png) | `Integer`                         | **Iterations**                 | Set this input iterate through the steps <br />A) Design -> B) ElementsFromMembers -> C) Analyse -> A) Design<br />To only run the above loop once set the input to 1.  |
