...
namespace GsaGH.Components {
  ...
  public class CreateProp2d : GH_OasysDropDownComponent {
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      if (_mode != Prop2dType.LoadPanel) {
        ...
        if (_mode != Prop2dType.Fabric) {
          ...
          if (_mode == Prop2dType.FlatPlate || _mode == Prop2dType.Shell
            ...
            if (da.GetData("Reference Surface", ref ghReferenceSurface)) {
              try {
                if (GH_Convert.ToInt32(ghReferenceSurface.Value, out int reference,
                  GH_Conversion.Both)) {
    ...
    private void SetInputProperties(
      int index, string nickname, string name, string description, bool optional = true) {
