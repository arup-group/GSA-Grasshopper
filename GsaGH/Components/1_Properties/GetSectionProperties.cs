...
namespace GsaGH.Components {
  ...
  public class GetSectionProperties : GH_OasysComponent, IGH_VariableParameterComponent {
    ...
    public virtual void VariableParameterMaintenance() {
      ...
      Params.Output[1].Name = "Moment of Inertia y-y [" + AreaMomentOfInertia.GetAbbreviation(inertiaUnit) + "]";
      Params.Output[2].Name = "Moment of Inertia z-z [" + AreaMomentOfInertia.GetAbbreviation(inertiaUnit) + "]";
      Params.Output[3].Name = "Moment of Inertia y-z [" + AreaMomentOfInertia.GetAbbreviation(inertiaUnit) + "]";
      Params.Output[4].Name = "Torsion constant [" + AreaMomentOfInertia.GetAbbreviation(inertiaUnit) + "]";
    }
