...
namespace GsaGH.Components {
  ...
  public class EditBool6 : GH_OasysComponent {
    ...
    protected override void RegisterInputParams(GH_InputParamManager pManager) {
      ...
      pManager.AddBooleanParameter("X", "X", "Release or restraint for translation in the X-direction.", GH_ParamAccess.item);
      pManager.AddBooleanParameter("Y", "Y", "Release or restraint for translation in the Y-direction.", GH_ParamAccess.item);
      pManager.AddBooleanParameter("Z", "Z", "Release or restraint for translation in the Z-direction.", GH_ParamAccess.item);
      pManager.AddBooleanParameter("XX", "XX", "Release or restraint for rotation around the X-axis.", GH_ParamAccess.item);
      pManager.AddBooleanParameter("YY", "YY", "Release or restraint for rotation around the Y-axis.", GH_ParamAccess.item);
      pManager.AddBooleanParameter("ZZ", "ZZ", "Release or restraint for rotation around the Z-axis.", GH_ParamAccess.item);
