...
namespace GsaGH.Components {
  public class CreateLoadCase : GH_OasysComponent {
    ...
    public CreateLoadCase() : base("Create Load Case", "LoadCase",
      "Create GSA Load Case", CategoryName.Name(), SubCategoryName.Cat3()) {
      Hidden = true;
    }
