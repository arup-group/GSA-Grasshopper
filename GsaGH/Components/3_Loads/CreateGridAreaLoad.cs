...
namespace GsaGH.Components {
  public class CreateGridAreaLoad : GH_OasysDropDownComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.AreaLoad;
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      if (da.GetData(1, ref ghBrep)) {
        ...
        if (curve.TryGetPolyline(out Polyline polyline)) {
          ...
          if (!planeSet) {
            ...
            if (Params.Input[2].SourceCount == 0 && _expansionType == ExpansionType.UseGpsSettings) {
              _expansionType = ExpansionType.To1D;
              this.AddRuntimeRemark("Input Brep has automatically been converted to a GridPlaneSurface." + Environment.NewLine + "The default expansion type is set to be onto 1D Elements." + Environment.NewLine + "You can change this by right-clicking the component.");
              UpdateMessage();
            }
      ...
      gridareaload.GridAreaLoad.Value = ((Pressure)Input.UnitNumber(this, da, 7, _forcePerAreaUnit)).NewtonsPerSquareMeter;
