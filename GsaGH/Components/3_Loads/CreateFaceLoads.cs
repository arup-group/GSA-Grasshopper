...
namespace GsaGH.Components {
  public class CreateFaceLoads : GH_OasysDropDownComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.FaceLoad;
      ...
      switch (_mode) {
        ...
        case FoldMode.Variable:
          if (_mode == FoldMode.Variable) {
            ...
            if (da.GetData(5, ref ghPrj))
              GH_Convert.ToBoolean(ghPrj, out prj, GH_Conversion.Both);
            faceLoad.FaceLoad.IsProjected = prj;
            faceLoad.FaceLoad.SetValue(0, ((Pressure)Input.UnitNumber(this, da, 6, _forcePerAreaUnit, true)).NewtonsPerSquareMeter);
            faceLoad.FaceLoad.SetValue(1, ((Pressure)Input.UnitNumber(this, da, 7, _forcePerAreaUnit, true)).NewtonsPerSquareMeter);
            faceLoad.FaceLoad.SetValue(2, ((Pressure)Input.UnitNumber(this, da, 8, _forcePerAreaUnit, true)).NewtonsPerSquareMeter);
            faceLoad.FaceLoad.SetValue(3, ((Pressure)Input.UnitNumber(this, da, 9, _forcePerAreaUnit, true)).NewtonsPerSquareMeter);
          }
          break;
        ...
        case FoldMode.Point:
          if (_mode == FoldMode.Point) {
            ...
            double s = 0;
            da.GetData(8, ref s);
            faceLoad.FaceLoad.SetValue(0, ((Pressure)Input.UnitNumber(this, da, 6, _forcePerAreaUnit)).NewtonsPerSquareMeter);
    ...
    public override void SetSelected(int i, int j) {
      ...
      if (i == 0) // change is made to the first dropdown list
      {
        ...
        _forcePerAreaUnit = (PressureUnit)UnitsHelper.Parse(typeof(PressureUnit), SelectedItems[1]);
