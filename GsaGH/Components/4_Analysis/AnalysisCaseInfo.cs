...
namespace GsaGH.Components {
  ...
  public class AnalysisCaseInfo : GH_OasysComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.AnalysisCaseInfo;
    ...
    protected override void RegisterInputParams(GH_InputParamManager pManager) => pManager.AddParameter(new GsaAnalysisCaseParameter());
