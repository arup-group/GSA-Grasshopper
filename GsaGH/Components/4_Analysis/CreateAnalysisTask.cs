...
namespace GsaGH.Components {
  ...
  public class CreateAnalysisTask : GH_OasysDropDownComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.CreateAnalysisTask;
    ...
    public override void SetSelected(int i, int j) {
      ...
      _analtype = (GsaAnalysisTask.AnalysisType)Enum.Parse(typeof(GsaAnalysisTask.AnalysisType), SelectedItems[i]);
      base.UpdateUI();
    }
    public override void UpdateUIFromSelectedItems() {
      _analtype = (GsaAnalysisTask.AnalysisType)Enum.Parse(typeof(GsaAnalysisTask.AnalysisType), SelectedItems[0]);
