...
namespace GsaGH.Components {
  ...
  public class EditAnalysisTask : GH_OasysComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.EditAnalysisTask;
      ...
      if (gsaTask != null) {
        ...
        if (da.GetDataList(1, ghTypes)) {
          ...
          for (int i = 0; i < ghTypes.Count; i++) {
            ...
            if (ghTyp2 == null) { Params.Owner.AddRuntimeWarning("Analysis Case input (index: " + i + ") is null and has been ignored"); continue; }
