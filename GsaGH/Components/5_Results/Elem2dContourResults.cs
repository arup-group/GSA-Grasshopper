  ...
  public class Elem2dContourResults : GH_OasysDropDownComponent {
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      if (da.GetDataList(2, ghColours)) {
        foreach (GH_Colour ghColor in ghColours)
        {
          GH_Convert.ToColor(ghColor, out Color color, GH_Conversion.Both);
          colors.Add(color);
        }
      }
      ...
      switch (_mode) {
        ...
        case FoldMode.Force:
          res = result.Element2DForceValues(elementlist,
            _forcePerLengthUnit, _forceUnit)[0];
      ...
      #region create mesh
      var resultMeshes = new MeshResultGoo(new Mesh(), new List<List<IQuantity>>(), new List<List<Point3d>>());
      ...
      if (lengthUnit == LengthUnit.Undefined) {
        ...
        this.AddRuntimeRemark("Model came straight out of GSA and we couldn't read the units. The geometry has been scaled to be in " + lengthUnit + ". This can be changed by right-clicking the component -> 'Select Units'");
      }
      else
      ...
      Helpers.PostHog.Result(result.Type, 2, resultType, _disp.ToString());
    }
    ...
    public override void SetSelected(int i, int j) {
      ...
      switch (i)
      {
        // if change is made to first list
        case 0:
        {
          switch (j)
          {
        ...
        // if change is made to second list, the type of result
        case 1:
        {
          bool redraw = false;
        ...
        // if change is made to third list
    ...
    public override void VariableParameterMaintenance() {
      ...
      switch (_mode)
      {
        ...
        case FoldMode.Displacement:
          ...
          break;
        case FoldMode.Force when (int)_disp < 4 | _isShear:
          Params.Output[2].Name = "Legend Values [" + ForcePerLength.GetAbbreviation(_forcePerLengthUnit) + "/" + Length.GetAbbreviation(_lengthUnit) + "]";
          break;
        case FoldMode.Force:
          Params.Output[2].Name = "Legend Values [" + Force.GetAbbreviation(_forceUnit) + "·" + Length.GetAbbreviation(_lengthUnit) + "/" + Length.GetAbbreviation(_lengthUnit) + "]";
          break;
        case FoldMode.Stress:
    ...
    public override bool Read(GH_IO.Serialization.GH_IReader reader) {
      ...
      _forcePerLengthUnit = (ForcePerLengthUnit)UnitsHelper.Parse(typeof(ForcePerLengthUnit), reader.GetString("force"));
