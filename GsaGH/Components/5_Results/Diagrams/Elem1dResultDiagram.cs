...
namespace GsaGH.Components {
  ...
  public class Elem1dResultDiagram : GH_OasysDropDownComponent {
    ...
    private readonly IDictionary<DiagramType, string> _dropDownList
      = new Dictionary<DiagramType, string> {
        {
          DiagramType.AxialForceFx, "Axial Force Fx"
        }, {
          DiagramType.ShearForceFy, "Shear Force Fy"
        }, {
          DiagramType.ShearForceFz, "Shear Force Fz"
        }, {
          DiagramType.TorsionMxx, "Torsion Mxx"
        }, {
          DiagramType.MomentMyy, "Moment Myy"
        }, {
          DiagramType.MomentMzz, "Moment Mzz"
        }, {
          DiagramType.ResolvedShearFyz, "Resolved Shear Fyz"
        }, {
          DiagramType.ResolvedMomentMyz, "Resolved Moment Myz"
        }, {
          DiagramType.AxialStressA, "Axial Stress A"
        }, {
          DiagramType.ShearStressSy, "Shear Stress Sy"
        }, {
          DiagramType.ShearStressSz, "Shear Stress Sz"
        }, {
          DiagramType.BendingStressByPositiveZ, "Bending Stress By Positive Z"
        }, {
          DiagramType.BendingStressByNegativeZ, "Bending Stress By Negative Z"
        }, {
          DiagramType.BendingStressBzPositiveY, "Bending Stress Bz Positive Y"
        }, {
          DiagramType.BendingStressBzNegativeY, "Bending Stress Bz Negative Y"
        }, {
          DiagramType.CombinedStressC1, "Combined Stress C1"
        }, {
          DiagramType.CombinedStressC2, "Combined Stress C2"
        },
      };
    private string _case = "";
    private double _defScale = 250;
    private DiagramType _displayedDiagramType = DiagramType.MomentMyy;
    ...
    public Elem1dResultDiagram() : base("1D Result Diagram", "ResultElem1dDiagram",
    ...
    public override void SetSelected(int i, int j) {
      ...
      //          _displayedDiagramType = DisplayValue.ResXyz;
      //          Mode1Clicked();
      //        }
      ...
      //          _displayedDiagramType = DisplayValue.Yy;
      //          Mode2Clicked();
      //        }
      ...
      //          _displayedDiagramType = DisplayValue.Y;
      //          Mode3Clicked();
      //        }
      ...
      //          _displayedDiagramType = DisplayValue.X;
      //          Mode4Clicked();
      //        }
      ...
      //    if (j < 4) {
      //      if ((int)_displayedDiagramType > 3) // chekc if we are coming from other half of display modes
      //      {
      ...
      //      }
      //    } else {
      //      if ((int)_displayedDiagramType < 4) // chekc if we are coming from other half of display modes
      //      {
      //        if (_mode == FoldMode.Displacement) {
      //          redraw = true;
      //          _slider = false;
      ...
      //    _displayedDiagramType = (DisplayValue)j;
    ...
    public override void VariableParameterMaintenance() {
      ...
      //switch (_mode) {
      //  case FoldMode.Displacement when (int)_displayedDiagramType < 4:
      ...
      //  case FoldMode.Force when (int)_displayedDiagramType < 4:
    ...
    protected override void BeforeSolveInstance() {
      //switch (_mode) {
      //  case FoldMode.Displacement:
      //    Message = (int)_displayedDiagramType < 4 ? Length.GetAbbreviation(_lengthResultUnit) :
      //      Angle.GetAbbreviation(AngleUnit.Radian);
      //    break;

      //  case FoldMode.Force:
      //    Message = (int)_displayedDiagramType < 4 ? Force.GetAbbreviation(_forceUnit) :
    ...
    protected override void InitialiseDropdowns() {
      ...
      _dropDownItems.Add(_dropDownList.Values.ToList());
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      //  case FoldMode.Force:
      //    res = result.Element1DForceValues(elementlist, positionsCount, _forceUnit,
      //      _momentUnit)[0];
      //    break;

      //  case FoldMode.StrainEnergy:
      //    res = _displayedDiagramType == DisplayValue.X ?
      ...
      //    dmax = dmaxX;
      //    dmin = dminX;
      //    if (_displayedDiagramType == DisplayValue.X) {
