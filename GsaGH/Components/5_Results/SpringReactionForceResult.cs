...
namespace GsaGH.Components {
  ...
  public class SpringReactionForce : GH_OasysDropDownComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.SpringReactionForces;
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      foreach (GH_ObjectWrapper ghTyp in ghTypes)
      {
        ...
        Tuple<List<GsaResultsValues>, List<int>> resultgetter = result.SpringReactionForceValues(nodeList, _forceUnit, _momentUnit);
