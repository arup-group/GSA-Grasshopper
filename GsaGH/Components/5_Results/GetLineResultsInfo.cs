...
namespace GsaGH.Components {
  public class GetLineResultsInfo : GH_OasysComponent {
    ...
    protected override void RegisterOutputParams(GH_OutputParamManager pManager) {
      ...
      pManager.AddGenericParameter("Result Value Start",
        "R1",
        "Result value at Segment Start as UnitNumber",
        GH_ParamAccess.item);
      pManager.AddGenericParameter("Result Value End",
        "R2",
        "Result value at Segment End as UnitNumber",
        GH_ParamAccess.item);
    }
