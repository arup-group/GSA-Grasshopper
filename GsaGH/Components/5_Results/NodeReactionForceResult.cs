...
namespace GsaGH.Components {
  ...
  public class ReactionForce : GH_OasysDropDownComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.ReactionForces;
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      foreach (GH_ObjectWrapper ghTyp in ghTypes) {
        ...
        (List<GsaResultsValues> vals, List<int> sortedIDs) = result.NodeReactionForceValues(nodeList, _forceUnit, _momentUnit);
