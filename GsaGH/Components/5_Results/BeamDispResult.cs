...
namespace GsaGH.Components {
  ...
  public class BeamDisplacement : GH_OasysDropDownComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.BeamDisplacement;
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      foreach (GH_ObjectWrapper ghTyp in ghTypes)
      {
        ...
        List<GsaResultsValues> vals = result.Element1DDisplacementValues(elementlist, positionsCount, _lengthUnit);
