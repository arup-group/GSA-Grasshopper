...
namespace GsaGH.Components {
  ...
  /// </summary>
  public class Edit1dMember_OBSOLETE : Section3dPreviewComponent, IGH_VariableParameterComponent {
    ...
    public Edit1dMember_OBSOLETE() : base("Edit 1D Member", "Mem1dEdit", "Modify GSA 1D Member",
