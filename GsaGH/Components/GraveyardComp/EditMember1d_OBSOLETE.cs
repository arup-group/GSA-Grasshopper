...
namespace GsaGH.Components {
  ...
  public class EditMember1d_OBSOLETE : GH_OasysComponent {
    ...
    protected override void RegisterOutputParams(GH_OutputParamManager pManager) {
      ...
      pManager.AddGenericParameter("Mesh Size [" + Length.GetAbbreviation(_lengthUnit) + "]", "Ms", "Get Member Mesh Size", GH_ParamAccess.item);
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      da.SetData(12, new GH_UnitNumber(new Length(mem.MeshSize, LengthUnit.Meter).ToUnit(_lengthUnit)));
