    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      switch (_mode) {
        case FoldMode.Displacement:
          Tuple<List<GsaResultsValues>, List<int>> nodedisp = result.NodeDisplacementValues(nodeList, _lengthUnit);
      ...
      ConcurrentDictionary<int, GsaNodeGoo> gsanodes = Helpers.Import.Nodes.GetNodeDictionary(nodes, _lengthUnit);
      double dmax = 0;
      double dmin = 0;
      switch (_disp) {
        case (DisplayValue.X):
