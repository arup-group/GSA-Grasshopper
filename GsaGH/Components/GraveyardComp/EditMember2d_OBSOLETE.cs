...
namespace GsaGH.Components {
  ...
  public class EditMember2d_OBSOLETE : GH_OasysComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.EditMem2d;
    ...
    protected override void RegisterInputParams(GH_InputParamManager pManager) {
      ...
      pManager.AddGenericParameter("Mesh Size [" + Length.GetAbbreviation(_lengthUnit) + "]", "Ms", "Set target mesh size", GH_ParamAccess.item);
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      da.SetData(10, new GH_UnitNumber(new Length(mem.MeshSize, LengthUnit.Meter).ToUnit(_lengthUnit)));
