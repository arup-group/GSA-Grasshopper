...
namespace GsaGH.Components {
  ...
  public class Elem1dContourResults_OBSOLETE : GH_OasysDropDownComponent {
    ...
    protected override System.Drawing.Bitmap Icon => Properties.Resources.Result1D;
    ...
    protected override void SolveInstance(IGH_DataAccess da) {
      ...
      Parallel.ForEach(elems, element => {
        ...
        for (int i = 0; i < positionsCount - 1; i++) {
          ...
          var start = new Point3d(line.PointAt((double)i / (positionsCount - 1)));
          var end = new Point3d(line.PointAt((double)(i + 1) / (positionsCount - 1)));
    ...
    #region Custom UI
    // ReSharper disable enum InconsistentNaming
