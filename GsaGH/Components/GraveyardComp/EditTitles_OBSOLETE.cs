...
namespace GsaGH.Components {
  ...
  public class EditGsaTitles_OBSOLETE : GH_OasysComponent {
    ...
    public EditGsaTitles_OBSOLETE() : base("Edit GSA Titles", "Title",
      "Set GSA Titles for this document", CategoryName.Name(), SubCategoryName.Cat0()) {
      Hidden = true;
    }
    ...
    protected override void RegisterOutputParams(GH_OutputParamManager pManager) {
      pManager.AddTextParameter("Titles", "Titles", "List of all Titles in document",
        GH_ParamAccess.list);
    }
