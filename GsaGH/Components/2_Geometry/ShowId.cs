          ...
          switch (goo) {
            ...
            case MeshResultGoo resMesh:
              for (int i = 0; i < resMesh.ElementIds.Count; i++) {
                _txts.Add(resMesh.ElementIds[i]
                  .ToString());
            ...
            case GsaMember3dGoo m3d:
              id = m3d.Value.Id;
              pt = m3d.Value.SolidMesh.GetBoundingBox(false)
                .Center;
              break;
            ...
            default:
              this.AddRuntimeWarning("Unable to convert "
                + goo.TypeName
