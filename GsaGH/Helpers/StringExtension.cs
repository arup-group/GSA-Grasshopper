...
namespace GsaGH.Helpers {
  public static class StringExtension {
    ...
    public static string ReleaseDescription(bool atStart = true) {
      string position = atStart ? "start" : "end";
      return "Set " + position + " release as Bool6 or string as \"fix\", \"pin\", \"free\" or \"FRFRFR\" where \"F\" represents fix and \"R\" as release.";
    }
