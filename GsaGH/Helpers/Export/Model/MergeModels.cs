...
namespace GsaGH.Helpers.Export
{
  public class MergeModels
  {
    ...
    public static GsaModel MergeModel(GsaModel mainModel, GsaModel appendModel)
    {
      ...
      mainModel.Model = AssembleModel.Assemble(mainModel, nodes, elem1ds, elem2ds, elem3ds, mem1ds, mem2ds, null, sections, prop2Ds, prop3Ds, loads, gps, null, null, LengthUnit.Meter, DefaultUnits.Tolerance.Meters);
      return mainModel;
    }
  }
}
