...
namespace GsaGH.Helpers.Export {
  internal partial class ModelAssembly {
    internal void ConvertProp2ds(List<GsaProperty2d> prop2Ds) {
      if (prop2Ds == null) {
        return;
      }
    ...
    internal int ConvertProp2d(GsaProperty2d prop2d) {
      if (prop2d == null) {
        return 0;
      }
    ...
    internal int AddProp2d(GsaProperty2d prop) {
      ...
      if (prop.LocalAxis != null && prop.LocalAxis.IsValid) {
        if (prop.LocalAxis != Plane.WorldXY && prop.LocalAxis != Plane.Unset) {
          ...
          prop.ApiProp2d.AxisProperty = Axes.AddValue(ax);
        } else {
