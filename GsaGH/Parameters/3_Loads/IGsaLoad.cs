...
namespace GsaGH.Parameters {
  ...
  /// <para>The next level of loading applies loads to the elements, either use the <see cref="Components.CreateBeamLoads"/> component, or <see cref="Components.CreateFaceLoads"/> component. In the solver these use shape functions to give loading on the nodes compatible with the elements to which the load is applied. </para>
