...
namespace GsaGH.Parameters.Results {
  public class Entity2dStresses : IMeshResultSubset<IMeshQuantity<IStress>, IStress, ResultTensor3<Entity2dExtremaKey>> {
    ...
    public ConcurrentDictionary<int, Collection<IMeshQuantity<IStress>>> Subset { get; }
      = new ConcurrentDictionary<int, Collection<IMeshQuantity<IStress>>>();

    public Entity2dStresses(ConcurrentDictionary<int, Collection<IMeshQuantity<IStress>>> results) {
      Subset = results;
