...
namespace GsaGH.Parameters.Results {
  public class Entity1dAverageStrainEnergyDensity : INodeResultSubset<IEnergyDensity, NodeExtremaKey> {
    ...
    public IDictionary<int, Collection<IEnergyDensity>> Subset { get; }
      = new ConcurrentDictionary<int, Collection<IEnergyDensity>>();

    public Entity1dAverageStrainEnergyDensity(IDictionary<int, Collection<IEnergyDensity>> results) {
      Subset = results;
