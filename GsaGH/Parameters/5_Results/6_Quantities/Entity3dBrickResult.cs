...
namespace GsaGH.Parameters.Results {
  public abstract class Entity3dBrickResult<ApiResultType, QuantityResult> : IEntity3dBrickQuantity<QuantityResult>
    ...
    internal Entity3dBrickResult(ReadOnlyCollection<ApiResultType> apiResult, Func<ApiResultType, QuantityResult> constructor) {
      int i = 0;
