...
namespace GsaGH.Parameters.Results {
  public abstract class Entity3dPyramidResult<ApiResultType, QuantityResult> : IEntity3dPyramidQuantity<QuantityResult>
    ...
    internal Entity3dPyramidResult(ReadOnlyCollection<ApiResultType> apiResult, Func<ApiResultType, QuantityResult> constructor) {
      int i = 0;
