...
namespace GsaGH.Parameters.Results {
  internal abstract class Entity3dBrick8Result<ApiResultType, QuantityResult> : IEntity3dBrick8Quantity<QuantityResult>
    ...
    public QuantityResult Face6Centre { get; private set; }

    internal Entity3dBrick8Result(ReadOnlyCollection<ApiResultType> apiResult, Func<ApiResultType, QuantityResult> constructor) {
      int i = 0;
      ...
      Face6Centre = constructor(apiResult[i++]);
    }
