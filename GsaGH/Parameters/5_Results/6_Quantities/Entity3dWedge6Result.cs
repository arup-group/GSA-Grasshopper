...
namespace GsaGH.Parameters.Results {
  internal abstract class Entity3dWedge6Result<ApiResultType, QuantityResult> : IEntity3dWedge6Quantity<QuantityResult>
    ...
    internal Entity3dWedge6Result(ReadOnlyCollection<ApiResultType> apiResult, Func<ApiResultType, QuantityResult> constructor) {
      int i = 0;
