...
namespace GsaGH.Parameters.Results {
  public class AssemblyDriftIndicesCache {
    ...
    public ConcurrentDictionary<int, IList<IEntity1dQuantity<IDrift<double>>>> Cache { get; }
        ...
        switch (ApiResult.Result) {
          case AnalysisCaseResult analysisCase:
            ...
            Parallel.ForEach(aCaseResults.Keys, entityId => {
              ...
              Cache.TryAdd(entityId, new List<IEntity1dQuantity<IDrift<double>>>() { results });
            });
            break;
          ...
          case CombinationCaseResult combinationCase:
            ...
            Parallel.ForEach(cCaseResults.Keys, entityId => {
              var permutationResults = new Collection<IEntity1dQuantity<IDrift<double>>>();
