...
namespace GsaGH.Parameters {
  public class GsaReinforcementMaterial : IGsaStandardMaterial<ReinforcementMaterial> {
    public ReinforcementMaterial StandardMaterial {
      get => _material;
      set {
        _material = value;
        Guid = Guid.NewGuid();
    ...
    public IGsaMaterial Duplicate() {
      try {
        ...
        ReinforcementMaterial mat = model.CreateReinforcementMaterial(Name);
        return new GsaReinforcementMaterial() {
        ...
        return new GsaReinforcementMaterial() {
          StandardMaterial = new ReinforcementMaterial() {
