...
namespace GsaGH.Parameters {
  /// <summary>
  /// <para>A GSA Entity List is expressed as a string of text in a specific syntax along with the List
  ...
  /// specify each individually or, if applicable, use a more concise <see href="https://docs.oasys-software.com/structural/gsa/references/listsandembeddedlists.html">syntax</see>.</para>
  /// </summary>
