...
namespace GhSA.Components
{
    public class CreateGridLineLoad : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddPointParameter("PolyLine", "Ln", "PolyLine. If you input grid plane below only x and y coordinate positions will be used from this polyline, but if not a new Grid Plane Surface (best-fit plane) will be created from PolyLine control points.", GH_ParamAccess.item);
            ...
            pManager.AddNumberParameter("Value Start (" + Util.GsaUnit.Force + ")", "V1", "Load Value (" + Util.GsaUnit.Force + ") at Start of Line", GH_ParamAccess.item);
            pManager.AddNumberParameter("Value End (" + Util.GsaUnit.Force + ")", "V2", "Load Value (" + Util.GsaUnit.Force + ") at End of Line (default : Start Value)", GH_ParamAccess.item);
