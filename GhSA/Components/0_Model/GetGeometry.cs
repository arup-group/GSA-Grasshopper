      ...
      if (results != null)
      {
        ...
        if (results.Elem1ds != null)
        {
          ...
          if (invalid1delem.Count > 0)
          {
            ...
            this.AddRuntimeMessage(GH_RuntimeMessageLevel.Warning, string.Join(" ", invalid1delem));
          }
          if (_mode == FoldMode.List)
        ...
        if (results.Mem1ds != null)
        {
          ...
          if (invalid1dmem.Count > 0)
          {
            ...
            this.AddRuntimeMessage(GH_RuntimeMessageLevel.Warning, string.Join(" ", invalid1dmem));
          }
          if (_mode == FoldMode.List)
        ...
        if (results.Mem2ds != null)
        {
          ...
          if (invalid2dmem.Count > 0)
          {
            ...
            this.AddRuntimeMessage(GH_RuntimeMessageLevel.Warning, string.Join(" ", invalid2dmem));
          }
          if (_mode == FoldMode.List)
        ...
        if (results.Mem3ds != null)
        {
          ...
          if (invalid3dmem.Count > 0)
          {
            ...
            this.AddRuntimeMessage(GH_RuntimeMessageLevel.Warning, string.Join(" ", invalid3dmem));
          }
          if (_mode == FoldMode.List)
