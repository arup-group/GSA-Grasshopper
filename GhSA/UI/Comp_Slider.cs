...
namespace GsaGH.UI
{
  ...
  /// </summary>
  public class SliderComponentUI : GH_ComponentAttributes
  {
    public SliderComponentUI(GH_Component owner, Action<double> sliderValue, Action<double, double> setMaxMinVals, double initValue, double minVal, double maxVal, int digits, string spacerText = "") : base(owner)
    {
