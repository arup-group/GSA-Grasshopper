    ...
    public class SectionTests
    {
        ...
        public void TestCreateSection()
        {
            ...
            double area = Math.Round(
                sect.Area.Value * Math.Pow(10, 6), // unit conversion
                10);
        ...
        public void TestCreateSectionProfile()
        {
            ...
            double area = sect.Area.Value * Math.Pow(10, 6); // unit conversion
            Assert.AreEqual(myarea, area);
        ...
        public void TestCreateGsaSectionCat()
        {
            ...
            double area = section.Area.Value * Math.Pow(10, 6);
        ...
        public void TestDuplicateSection()
        {
            ...
            double area2 = orig.Area.Value * Math.Pow(10, 6);
            Assert.AreEqual("STD R 15 20", orig.Profile);
            Assert.AreEqual(myarea2, area2);

            double area1 = dup.Area.Value * Math.Pow(10, 6);
