...
$coverageFileAdsecGh = Get-ChildItem -Path .\results\GsaGh\**\* -Filter 'coverage.cobertura.xml' | Sort-Object LastWriteTime -Descending | Select-Object -First 1
...
# generate the report
reportgenerator -reports:$coverageFileAdsecGh.FullName -targetdir:.\results\CoverageReportGsaGh\
