...
namespace GsaGHTests.Parameters
{
  ...
  public class VectorResultGooTests
  {
    ...
    public void WhenInitialised_ThenClassContainSetColorMethod()
    {
     ...
     var setColorMethodInfo = actualMethods.FirstOrDefault(method => method.Name.Equals("SetColor"));
    ...
    public void WhenInitialised_ThenClassContainShowTextMethod()
    {
     ...
     var showTextMethodInfo = actualMethods.FirstOrDefault(method => method.Name.Equals("ShowText"));
    ...
    public void WhenInitialised_ThenClassContainDrawArrowHeadMethod()
    {
     ...
     var showTextMethodInfo = actualMethods.FirstOrDefault(method => method.Name.Equals("DrawArrowHead"));
