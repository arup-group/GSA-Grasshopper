...
namespace GsaGHTests.Components.Loads {
  ...
  public class CreateNodeLoadTests {
    ...
    public void CreateNodeForceTest() {
      ...
      Assert.Equal(10, load._refPoint.X, new DoubleComparer());
      Assert.Equal(5, load._refPoint.Y, new DoubleComparer());
      Assert.Equal(-1, load._refPoint.Z, new DoubleComparer());
