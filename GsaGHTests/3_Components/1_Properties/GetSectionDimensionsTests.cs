...
namespace GsaGHTests.Components.Properties {
  ...
  public class GetSectionDimensionsTests {
    ...
    [Theory]
    [InlineData("STD A(cm) 25 30 4.5 6.7",
      25,
      30,
      30,
      30,
    ...
    [InlineData("STD CH 100 200 10 15",
      100,
      200,
      200,
      200,
    ...
    [InlineData("STD GC 100 200 7 8",
      ...
      0,
      LengthUnit.Millimeter)]
    [InlineData("STD GZ 300 150 200 15 10 5",
      300,
      350,
      150,
      200,
      ...
      0,
      LengthUnit.Millimeter)]
    [InlineData("STD GI 900 200 400 15 40 30",
      900,
      400,
      200,
      400,
      ...
      0,
      LengthUnit.Millimeter)]
    [InlineData("STD CB 900 400 15 40 400 1500",
      900,
      400,
      400,
      400,
    ...
    [InlineData("STD I 1000 200 7 8",
      ...
      0,
      LengthUnit.Millimeter)]
    [InlineData("STD RHS 400 200 7 8",
      400,
      200,
      200,
      200,
    ...
    [InlineData("STD R 250 300",
      ...
      0,
      LengthUnit.Millimeter)]
    [InlineData("STD RE 400 250 350 200 2",
      400,
      350,
      250,
      200,
    ...
    [InlineData("STD SPW 250 150 4",
      ...
      150,
      LengthUnit.Millimeter)]
    [InlineData("STD SHT 500 600 150 250 15 10",
      500,
      600,
      150,
      250,
    ...
    public void CreateComponent(
      ...
      double expectedWidthTop,
      double expectedWidthBottom,
      double expectedFlngThkTop,
      double expectedFlngThkBtm,
      double expectedWebThk,
      double expectedRootRadius,
