...
namespace GsaGHTests.Components.Properties {
  ...
  public class GetSectionPropertiesTests {
    ...
    public void CreateComponent(
      ...
      var j = (GH_UnitNumber)ComponentTestHelper.GetOutput(comp, 4);
      var ky = (GH_UnitNumber)ComponentTestHelper.GetOutput(comp, 5);
      var kz = (GH_UnitNumber)ComponentTestHelper.GetOutput(comp, 6);
      var sl = (GH_UnitNumber)ComponentTestHelper.GetOutput(comp, 7);
      var vl = (GH_UnitNumber)ComponentTestHelper.GetOutput(comp, 8);
      ...
      Assert.Equal(expectedKy, ky.Value.Value, 6);
      Assert.Equal(expectedKz, kz.Value.Value, 6);
