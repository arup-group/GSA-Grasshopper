...
namespace GsaGHTests.Components.Analysis {
  ...
  public class CreateAnalysisTaskTests {
    ...
    public void CreateFootfallComponentTest1(string responseDirection, int weightingCurve, int excitationForces, int expectedResponsDirection, Type excitationForcesType) {
      var comp = new CreateAnalysisTask();
      comp.CreateAttributes();
    ...
    public void CreateFootfallComponentTest2(int responseDirection, int weightingCurve, int excitationForces, int expectedResponsDirection, Type excitationForcesType) {
      var comp = new CreateAnalysisTask();
      comp.CreateAttributes();
    ...
    [Fact]
    public void CreateFootfallComponentTest3() {
      var comp = new CreateAnalysisTask();
      comp.CreateAttributes();
      ...
      ComponentTestHelper.SetInput(comp, "X", 7);
