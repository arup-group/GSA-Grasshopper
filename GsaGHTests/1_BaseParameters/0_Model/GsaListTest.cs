...
namespace GsaGHTests.Parameters {
  ...
  public class GsaListTest {
    ...
    public void TestUndefinedList() {
      ...
      Assert.Equal(GsaGH.Parameters.Enums.EntityType.Undefined, list.EntityType);
    ...
    public void TestNodeList() {
      ...
      Assert.Equal(GsaGH.Parameters.Enums.EntityType.Node, list.EntityType);
    ...
    public void TestElementList() {
      ...
      Assert.Equal(GsaGH.Parameters.Enums.EntityType.Element, list.EntityType);
    ...
    public void TestMemberList() {
      ...
      Assert.Equal(GsaGH.Parameters.Enums.EntityType.Member, list.EntityType);
