...
namespace GsaGHTests.Parameters {
  ...
  public class GsaGridPlaneSurfaceTest {
    ...
    public void ConstructorTest(
      ...
      Assert.Equal(string.Empty, gps.GridPlane.Name);
      ...
      Assert.Equal(string.Empty, gps.GridSurface.Name);
    ...
    public void DuplicateTest() {
      ...
      duplicate.GridSurface.Elements = string.Empty;
      ...
      Assert.Equal(string.Empty, original.GridPlane.Name);
      ...
      Assert.Equal(string.Empty, original.GridSurface.Name);
