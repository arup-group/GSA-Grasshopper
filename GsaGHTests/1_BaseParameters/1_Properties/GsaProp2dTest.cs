...
namespace GsaGHTests.Parameters {
  ...
  public class GsaProp2dTests {
    ...
    public void TestCreateProp2d() {
      ...
      Assert.Equal(MaterialType.GENERIC.ToString(), prop.Material.MaterialType.ToString());
    ...
    public void TestDuplicateProp2d() {
      ...
      Assert.Equal(MaterialType.UNDEF.ToString(), dup.Material.MaterialType.ToString());
      ...
      Assert.Equal(MaterialType.FABRIC.ToString(), orig.Material.MaterialType.ToString());
